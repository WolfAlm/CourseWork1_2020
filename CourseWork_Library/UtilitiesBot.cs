...
namespace OftenColorBotLibrary
{
    public class UtilitiesBot
    {
        ...
        static public readonly Dictionary<string, string> infoText = new Dictionary<string, string>()
        {
            ...
            "*любителя* — обычная палитра, и наконец, режим *новичок* выводит палитру с названиями" +
            ...
            "*любитель* — обычная палитра цветов, *новичок* выводит палитру с названиями" +
            "цветов.",
            ...
            ["start"] = new InlineKeyboardMarkup(new[]
                    {
                            ...
                            new []
                            {
                                InlineKeyboardButton.WithCallbackData("🦹🏼‍♀️ Новичок", "новичок")
                            }
                    }),
